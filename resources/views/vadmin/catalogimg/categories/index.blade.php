	...
	@component('vadmin.components.headerfixed')
		...
		@slot('actions')
			...
			<div class="list-actions">
				<a href="{{ route('catimg_categorias.create') }}" class="btn btnBlue"><i class="icon-plus-round"></i>  Nueva Categoría</a>
				...
				<input id="ModelName" type="hidden" value="catimg_categorias">
		...
		@endslot
		@slot('searcher')
			@include('vadmin.catalogimg.categories.searcher')
		@endslot
	@endcomponent
@endsection
